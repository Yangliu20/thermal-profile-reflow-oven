...
[M,n,p] = GeneticAlgorithm_Q4(20, 50, 0.3, 0.2, 1);
...
plot([0, timePointAbove217_right], [point217(2), point217(2)], '--',  'LineWidth', 1.5, 'color', 'k'); % 水平线
...
plot([timePointAbove217_right, timePointAbove217_right], [0, 217], '--', 'LineWidth', 1.5, 'color', 'k'); % 竖直线
hold off;
xlabel('t (s)');
ylabel('T (degC)');
...
fprintf('true area = %d \n',trapz(line_x, line_y - 217)); % 积分得到的真实面积
fprintf('ratio = %d \n',ratio); % 对称指标，越小越好
